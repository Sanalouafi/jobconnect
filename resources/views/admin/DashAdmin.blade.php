...
<body>
    ...
    <x-app-layout>
        ...
        <button class="text-black bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
        Show navigation
        </button>
        </div>  --}}
        {{--  <x-slot name="header">
      ...
      <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-dark">
        ...
        <div class="container mx-auto p-4">
            <div class="flex flex-wrap justify-center">
                <div
                    class="lg:w-6/12 md:w-6/12 sm:w-12 mt-5 bg-gray-200 rounded-lg overflow-hidden shadow-md card mx-2">
        ...
        <div class="container mx-auto p-8 mb-10 bg-white rounded-lg shadow-md">
            <h2 class="text-2xl font-semibold mb-4">Porject Management</h2>
            <a href="{{ route('projects.create') }}"> <button type="button"
                    class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none bg-blue-600 rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Add_New_Porject</button></a>
            <div class="overflow-x-auto">
                <form action="" method="get" class="w-full">
                    <table class="w-full table-auto border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
                                <th class="px-6 py-3 border-b">Project ID</th>
                                <th class="px-6 py-3 border-b">name</th>
                                <th class="px-6 py-3 border-b">description</th>
                                <th class="px-6 py-3 border-b">status</th>
                                <th class="px-6 py-3 border-b">start_date</th>
                                <th class="px-6 py-3 border-b">end_date</th>
                                <th class="px-6 py-3 border-b">image</th>
                                <th class="px-6 py-3 border-b">budget</th>
                                <th class="px-6 py-3 border-b">partner_id</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            @foreach ($projects as $project)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-3 border-b">{{ $project->description }}</td>
                                    <td class="px-6 py-3 border-b">{{ $project->status }}</td>
                                    <td class="px-6 py-3 border-b">{{ $project->start_date }}</td>
                                    <td class="px-6 py-3 border-b">{{ $project->end_date }}</td>
                                    <td class="px-6 py-3 border-b h-32 w-28"><img
                                            src="{{ $project->getFirstMediaUrl('images') }}" alt="image"></td>
