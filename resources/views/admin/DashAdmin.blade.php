...
<body>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <div class="text-center">
                        <button
                            class="text-black bg-blue-100 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-500 dark:hover:bg-blue-500 focus:outline-none dark:focus:ring-blue-800"
                        ...
                        <div>
                            <button type="button"
                                ...
                                <img class="w-8 h-8 rounded-full"
                                    src="{{ Auth::user()->getFirstMediaUrl('user') }}"
                                    alt="user photo">
                            </button>
                        </div>
    ...
    <div id="drawer-navigation"
        class="fixed mt-10 top-10 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800"
