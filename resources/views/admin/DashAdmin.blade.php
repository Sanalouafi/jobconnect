...
<body>
  ...
  <div class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-200 dark:border-gray-200">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <div class="text-center">
            <button class="text-black bg-blue-100 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-500 dark:hover:bg-blue-500 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
...
<div id="drawer-navigation" class="fixed mt-10 top-10 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
  ...
  <div class="py-4 overflow-y-auto">
    ...
    <div class="container mt-20 mx-auto p-4">
        <div class="flex flex-wrap justify-between items-center">
            <div class="lg:w-5/12 md:w-6/12 sm:w-full mb-4">
                <h1 class="text-3xl font-bold">Good Morning, M.{{ Auth::user()->fullname }}!</h1>
    ...
    <div class="container mx-auto p-4">
        <div class="flex flex-wrap justify-center">
            <div class="lg:w-3/12 md:w-3/12 sm:w-12 mt-5 bg-gray-200 rounded-lg overflow-hidden shadow-md card mx-2">

                <a href="#"
                    class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-200 dark:border-gray-200 dark:hover:bg-gray-700">
    ...
    <div class="container mx-auto p-8 mb-10 bg-white rounded-lg shadow-lg">
